...
public class AgeCaseInvesFragment extends BaseActivityFragment{
    ...
    private void initData() {
        ...
        MessageEvent messageEvent = new MessageEvent<Integer>("AGE_CASEINVES", list.size());
        EventBus.getDefault().post(messageEvent);
    }

    public void getDataByAge(String startAge, String endAge) {
        list = CaseInvesManager.getInstance().getCaseInvesListByAge(startAge, endAge);
        adapter.setData(list);
