...
public class Users implements Serializable{
    ...
    private List<CaseInves> caseInvesList;
    private List<Verifications> verificationsList;
    ...
    public List<CaseInves> getCaseInvesList() {
        if (caseInvesList == null) {
            List<CaseInves> list = CaseInvesManager.getInstance().getCaseInvesList(getRealName(), null, null, null);
            synchronized (this) {
                if(caseInvesList == null) {
                    caseInvesList = list;
                }
        ...
        return caseInvesList;
    }

    public List<Verifications> getVerificationsList() {
        if (verificationsList == null) {
            List<Verifications> list = VerificationsManager.getInstance().getVerificationList(getRealName(), null, null, null);
            synchronized (this) {
                if(verificationsList == null) {
    ...
    public List<Letters> getLettersList() {
        if (lettersList == null) {
            List<Letters> list = LettersManager.getInstance().getLetterList(getRealName(), null, null, null);
            synchronized (this) {
                if(lettersList == null) {
                    lettersList = list;
                }
