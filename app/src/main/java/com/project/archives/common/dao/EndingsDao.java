...
/** 
 * DAO for table "Endings".
*/
public class EndingsDao extends AbstractDao<Endings, byte[]> {

    public static final String TABLENAME = "Endings";

    /**
     * Properties of entity Endings.<br/>
    ...
    public EndingsDao(DaoConfig config) {
        super(config);
    }
    
    public EndingsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"Endings\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"Endings\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Endings entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Endings entity) {
        stmt.clearBindings();
    ...
    @Override
    public Endings readEntity(Cursor cursor, int offset) {
        Endings entity = new Endings( //
    ...
    @Override
    public void readEntity(Cursor cursor, Endings entity, int offset) {
    ...
    @Override
    protected final byte[] updateKeyAfterInsert(Endings entity, long rowId) {
        return entity.getID();
    }
    
    @Override
    public byte[] getKey(Endings entity) {
        if(entity != null) {
            return entity.getID();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Endings entity) {
