...
import com.project.archives.function.detail.activity.LettersDetailActivity;

/**
 * Created by inrokei on 2018/5/1.
 */

public class LettersListAdapter extends MyBaseAdapter<Letters> {
    private Context context;

    public LettersListAdapter(Context c) {
        super(c);
        context = c;
    }
    ...
    protected View getView(int position, View convertView, ViewGroup parent, ViewHolder holder) {
        ...
        ll_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, LettersDetailActivity.class);
