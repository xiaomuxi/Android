...
public class CaseInvesDao extends AbstractDao<CaseInves, byte[]> {
    ...
    @Override
    protected final void attachEntity(CaseInves entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM CASE_INVES T");
    ...
    protected CaseInves loadCurrentDeep(Cursor cursor, boolean lock) {
        CaseInves entity = loadCurrent(cursor, 0, lock);
    ...
    public CaseInves loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<CaseInves> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<CaseInves> list = new ArrayList<CaseInves>(count);
    ...
    protected List<CaseInves> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<CaseInves> queryDeep(String where, String... selectionArg) {
