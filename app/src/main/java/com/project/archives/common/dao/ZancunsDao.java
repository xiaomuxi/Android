...
/** 
 * DAO for table "Zancuns".
*/
public class ZancunsDao extends AbstractDao<Zancuns, byte[]> {

    public static final String TABLENAME = "Zancuns";

    /**
     * Properties of entity Zancuns.<br/>
    ...
    public static class Properties {
        ...
        public final static Property ZancunTime = new Property(8, String.class, "ZancunTime", false, "ZancunTime");
    ...
    public ZancunsDao(DaoConfig config) {
        super(config);
    }
    
    public ZancunsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"Zancuns\" (" + //
                ...
                "\"Note\" TEXT," + // 16: Note
                "\"AnnexIDStr\" BLOB," + // 17: AnnexIDStr
                "\"isDelete\" INTEGER," + // 18: isDelete
                "\"AddDate\" TEXT," + // 19: AddDate
                "\"AddUser\" TEXT," + // 20: AddUser
                "\"UpdateDate\" TEXT," + // 21: UpdateDate
                "\"UpdateUser\" TEXT," + // 22: UpdateUser
                "\"objectSource\" INTEGER);"); // 23: objectSource
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"Zancuns\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Zancuns entity) {
        stmt.clearBindings();
        ...
        String ZancunTime = entity.getZancunTime();
        if (ZancunTime != null) {
            stmt.bindString(9, ZancunTime);
        }
        ...
        if (UpdateUser != null) {
            stmt.bindString(23, UpdateUser);
        }
 
        Integer objectSource = entity.getObjectSource();
        if (objectSource != null) {
            stmt.bindLong(24, objectSource);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, Zancuns entity) {
        stmt.clearBindings();
    ...
    @Override
    public Zancuns readEntity(Cursor cursor, int offset) {
        Zancuns entity = new Zancuns( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // ZancunTime
    ...
    @Override
    public void readEntity(Cursor cursor, Zancuns entity, int offset) {
        ...
        entity.setZancunTime(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
    ...
    @Override
    protected final byte[] updateKeyAfterInsert(Zancuns entity, long rowId) {
        return entity.getID();
    }
    
    @Override
    public byte[] getKey(Zancuns entity) {
        if(entity != null) {
            return entity.getID();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Zancuns entity) {
