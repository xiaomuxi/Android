...
public class AgeFragment extends BaseActivityFragment {
    ...
    protected View setContentView() {
        return UIUtils.inflate(mContext, R.layout.fragment_list_age);
    }
    ...
    private void initViewPgaer(View view) {
        ...
        et_search_start = (EditText)view.findViewById(R.id.et_search_start);
        et_search_end = (EditText) view.findViewById(R.id.et_search_end);
